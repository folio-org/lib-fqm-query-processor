...
class StreamHelperTest {
  ...
  void shouldChunkStream_sizeMoreThanElementsCount() {
    ...
    Stream<List<Integer>> resultStream = StreamHelper.chunk(originalStream, 100);
    List<List<Integer>> resultList = resultStream.toList();
  ...
  @Test
  void shouldCloseOriginalStreamWhenResultStreamClosed() throws ExecutionException, InterruptedException, TimeoutException {
